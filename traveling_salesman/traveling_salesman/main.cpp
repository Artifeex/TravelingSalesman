...
void GetParamsAntColonyAlg() {
  cout << "Введите значение параметра alfa: ";
  cin >> alfa;
  cout << endl;
  cout << "Введите значение параметра beta: ";
  cin >> beta;
  cout << endl;
  cout << "Введите значение начального значения феромона на каждой грани: ";
  cin >> startPheromone;
  cout << endl;
  cout << "Введите количество муравьев: ";
  cin >> countAnts;
  cout << endl;
  cout << "Введите значение параметры убывания феромона между итерациями: ";
  cin >> pheromoneResidue;
  cout << endl;
  cout << "Введите значение феромона, который суммарно выделяется в одной итерации: ";
  cin >> totalPheromone;
  cout << endl;
